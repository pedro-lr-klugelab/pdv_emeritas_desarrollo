...
namespace Farmacontrol_PDV.FORMS.catalogos.catalogo_clientes
{
	public partial class Editar_cliente : Form
	{
		...
		public Editar_cliente(string cliente_id_hex, int? empleado_id)
		{
		...
		private void Editar_cliente_Load(object sender, EventArgs e)
		{
            ...
            dvg_historial.SelectionMode = DataGridViewSelectionMode.CellSelect;
            dvg_historial.ClipboardCopyMode = DataGridViewClipboardCopyMode.EnableWithAutoHeaderText;
		...
		public void rellenar_informacion_cliente()
		{
            ...
            dvg_historial.DataSource = dao_clientes.get_historico_data(cliente_id_hex);
		...
		{
            dao_clientes.actualizar_cliente(cliente_id_hex, txt_nombre.Text,Convert.ToDecimal(txt_limite_credito.Text), rbt_ca_si.Checked, txt_comentarios.Text, empleado_id);
			rellenar_informacion_cliente();
		}
        ...
        {
            Registrar_domicilios registro_domicilio = new Registrar_domicilios(cliente_id_hex, dgv_domicilios.SelectedRows[0].Cells["cliente_domicilio_id"].Value.ToString(), "edicion");
            registro_domicilio.ShowDialog();
            dgv_domicilios.DataSource = dao_clientes.get_cliente_domicilio_data(cliente_id_hex);
        }
        ...
        private void dgv_domicilios_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
